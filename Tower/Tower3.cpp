...
Tower3::Tower3(float x, float y, Team* team) : 
    Tower("play/tower-base.png", "play/turret-1.png", x, y, 64 * 3 + 32, Price, 0.5, 
          team->damageOffset, 
...
void Tower3::CreateBullet()
{
    ...
    getPlayScene()->BulletGroup->AddNewObject(new Bullet3(Position + normalized * 36, diff, rotation, this, 2 + damageOffset));
...
void Tower3::Update(float deltaTime) {
    ...
    Instance* n = new Instance3(objx, objy, team->ID, FlyTarget, GroundTarget);
