...
Tower5::Tower5(float x, float y, Team* team) : 
    Tower("play/tower-base.png", "play/turret-5.png", x, y, 32, Price, 5, 
          team->damageOffset, 
...
void Tower5::Update(float deltaTime) {
    ...
    Instance* n = new Instance5(objx, objy, team->ID, FlyTarget, GroundTarget);
    n->UpdatePath(team->groundMap, team->endPoint);
    team->GroundGroup->AddNewObject(n);
    n = new Instance6(objx, objy, team->ID, FlyTarget, GroundTarget);
